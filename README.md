...
- [MvvmCross](https://github.com/MvvmCross/MvvmCross/labels/first-timers-only) _(label: first-timers-only)_ <br> The .NET MVVM(Model–view–viewmodel) framework for cross-platform solutions, including Xamarin.iOS, Xamarin.Android, Windows and Mac.
...
- [dart.dev](https://github.com/dart-lang/site-www/labels/beginner) _(label: beginner)_ <br> A website covering the Dart language and common libraries, for developers of Dart libraries, web apps, server-side code, Desktop apps(Beta) and mobile (Flutter) apps.
